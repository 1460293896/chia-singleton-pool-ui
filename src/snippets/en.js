export default {
  'account-service.login.error.invalid-farmer': 'Could not find farmer for launcher id "{1}"',
  ...
  'api.error.invalid_authentication_token': 'The authentication token is invalid!',
  ...
  'blocks-won-component.header.effort': 'Effort',
  ...
  'blocks-won-component.in-mempool': 'In Mempool',
  ...
  'farmer-payout-history-component.chart.amount.name': 'Amount',
  ...
  'my-farmer-component.collateral-balance-card.progress.help': '{1}% of your collateral reached',
  ...
  'my-farmer-component.ec-card.help': 'The effective capacity (EC) is calculated based on the last 24h of partials submitted to the pool and as such can vary.',
  'my-farmer-component.estimated-daily-reward-card.title': 'Estimated daily reward',
  'my-farmer-component.estimated-daily-reward-card.help': 'The estimated daily reward is calculated based on your current EC and the pools average daily reward per PiB over the past 7 days, which is shown on the dashboard.',
  ...
  'my-farmer-component.manage-account-card.auth-info': 'To authenticate please log in via your wallet as described <a href="{1}" target="_blank">here</a>',
  ...
  'my-farmer-component.pending-balance-card.progress.help': '{1}% of the minimum payout reached',
  'my-farmer-component.singleton-genesis-input.error.missing': 'No Launcher Id entered!',
  ...
  'my-farmer-component.shares-chart.title': '24h Shares',
  'my-farmer-component.shares-chart.shares.name': 'Shares',
  'my-farmer-component.shares-chart.valid-shares.name': 'Valid Shares',
  'my-farmer-component.shares-chart.invalid-shares.name': 'Invalid Shares',
  'my-farmer-component.shares-chart.stale-shares.name': 'Stale Shares',
  'my-farmer-component.shares-chart.difficulty.name': 'Difficulty',
  ...
  'payouts-component.confirmed': 'Confirmed',
  'payouts-component.partially-confirmed': 'Partially Confirmed',
  'payouts-component.in-mempool': 'In Mempool',
  'pool-history-component.chart.title': 'Pool History',
  'pool-history-component.chart.blocks.name': 'Blocks',
  'pool-history-component.chart.effort.name': 'Effort',
  'pool-history-component.chart.pool-ec.name': 'Pool EC',
  'pool-history-component.chart.capacity.name': 'Capacity',
  'pool-history-component.chart.network-capacity.name': 'Network Capacity',
  ...
  'stats-card-component.daily-reward.help': 'The daily reward is an estimate based on the average farming rewards of this pool over the past 7 days. It is calculated per pebibyte (PiB) of farming capacity.',
  'stats-card-component.farmers': 'Farmers',
  'stats-card-component.pool-ec': 'Pool EC',
  'stats-card-component.current-effort': 'Current Effort',
  'stats-card-component.current-effort.help': 'The current effort shows the effort since the last won block. The effort is given in percent, where 100% equals the pools estimated time to win.',
  'stats-card-component.height': 'Height',
  'stats-card-component.network-capacity': 'Network Capacity',
  'stats-card-component.network-difficulty': 'Network Difficulty',
